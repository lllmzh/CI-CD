function myfunc() {
    ...
    if (b1.toLowerCase() == 'x' && b2.toLowerCase() == 'x' && b3.toLowerCase() == 'x') {
        ...
        window.alert('You are a winner');
        reset();
    } else if (b3.toLowerCase() == 'x' && b5.toLowerCase() == 'x' && b9.toLowerCase() == 'x') {
        window.alert('You are a winner');
        reset();
    }

    if (bl.tolowerCase() == 'o' && b2.tolowerCase() == 'o' && b3.tolowerCase() == 'o') {
        window.alert('You are a winner');
        reset(); 
    } else if (b4.toLowerCase() == 'o' && b5.toLowercase() == 'o' && b6.tolowerCase() == 'o') {
        window.alert('You are a winner');
        reset();
    } else if (b7.toLowerCase() == 'o' && b8.tolLowerCase() == 'o' && b9.toLowerCase() == 'o') {
        window.alert('You are a winner');
        reset();
